...
public class Camera2Base extends com.kagaconnect.rtp.base.Camera2Base implements SurfaceHolder.Callback {
    ...
    public void startPreview(CameraHelper.Facing cameraFacing, int width, int height) {
        super.startPreview(cameraFacing, width, height);
    }

    public void startPreview(CameraHelper.Facing cameraFacing, int rotation) {
        super.startPreview(cameraFacing, rotation);
    }
