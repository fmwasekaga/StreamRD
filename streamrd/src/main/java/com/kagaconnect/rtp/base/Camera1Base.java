...
public abstract class Camera1Base
  ...
  private Camera1ApiManagerExtension cameraManager;
  ...
  public Camera1Base(SurfaceView surfaceView) {
    ...
    cameraManager = new Camera1ApiManagerExtension(surfaceView, this);
    init();
  }

  public Camera1Base(TextureView textureView) {
    context = textureView.getContext();
    cameraManager = new Camera1ApiManagerExtension(textureView, this);
    init();
  }
  ...
  public Camera1Base(OpenGlView openGlView) {
    ...
    cameraManager = new Camera1ApiManagerExtension(glInterface.getSurfaceTexture(), context);
    init();
  }
  ...
  public void captureCameraInfo(CameraInfoCallback cameraInfoCallback) {
    cameraManager.captureCameraInfo(cameraInfoCallback);
  }
  ...
  public void startRecord(@NonNull final String path, @Nullable RecordController.Listener listener)
    ...
    if (!streaming) {
      ...
      if (!streaming)resetVideoEncoder();
    }
  }
  ...
  public void fixDarkPreview(){
    cameraManager.fixDarkPreview();
  }

  public void setExposureTime(float time, float maximumExposureTime){
    cameraManager.setExposureTime(time, maximumExposureTime);
  }
  ...
  public void setExposureCompensation(int compensation){
    cameraManager.setExposureCompensation(compensation);
  }

  public void setFocusDistanceInMeters(float distance){
    cameraManager.setFocusDistanceInMeters(distance);
  }

  public void setColorCorrection(RggbChannelVector colorCorrection){
    cameraManager.setColorCorrection(colorCorrection);
  }
}