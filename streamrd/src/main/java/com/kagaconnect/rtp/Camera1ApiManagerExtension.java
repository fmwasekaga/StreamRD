...
public class Camera1ApiManagerExtension  implements Camera.PreviewCallback, Camera.FaceDetectionListener {
    ...
    public Camera1ApiManagerExtension(SurfaceView surfaceView, GetCameraData getCameraData) {
    ...
    public Camera1ApiManagerExtension(TextureView textureView, GetCameraData getCameraData) {
    ...
    public Camera1ApiManagerExtension(SurfaceTexture surfaceTexture, Context context) {
