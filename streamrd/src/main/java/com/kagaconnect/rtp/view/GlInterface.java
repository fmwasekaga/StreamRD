...
public interface GlInterface {
   ...
   * You can select any filter from {@link com.kagaconnect.encoder.input.gl.render.filters} or create
   * your own filter if you extends from {@link com.kagaconnect.encoder.input.gl.render.filters.BaseFilterRender}
   *
